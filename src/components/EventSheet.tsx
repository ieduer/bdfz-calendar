...
import { categoryMeta } from "../lib/calendar";
...
export function EventSheet({ event, onClose }: EventSheetProps) {
  ...
  return (
    <div className="event-sheet" role="dialog" aria-modal="true" aria-label={event.title}>
      <button className="sheet-scrim" type="button" aria-label="关闭事件详情" onClick={onClose} />
      <section className="sheet-panel">
        <div className={`sheet-ribbon ${meta.className}`} />
